...
const faqs = [
  ...
  { q: 'What AI models do you use?', a: 'All plans use advanced AI for fast, accurate responses. Growth plans and above unlock our most capable model with smart routing — automatically selecting the best model per query to balance speed and quality.' },
