...
export const metadata: Metadata = {
  title: 'About — PageAI',
  description: 'Learn about PageAI — the platform that lets any business deploy AI chatbots trained on their website in minutes.',
};
    ...
    <div className="min-h-screen bg-bg text-fg">
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-[760px] mx-auto">
          ...
          <p className="text-[18px] text-fg-secondary leading-relaxed mb-8">PageAI makes it simple for any business to deploy intelligent AI chatbots — trained on their own website, answering real customer questions in real time, with no coding required.</p>
          ...
          <div className="mt-16 space-y-8">
            <div>
              ...
              <p className="text-[15px] text-fg-secondary leading-relaxed">Every website has a wealth of information trapped in pages that users never find. PageAI bridges that gap — turning your existing content into a 24/7 AI assistant that speaks your language, knows your products, and helps your customers instantly.</p>
            </div>
            <div>
