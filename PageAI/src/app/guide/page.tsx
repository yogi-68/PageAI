...
export const metadata: Metadata = {
  title: 'Getting Started Guide — PageAI',
  description: 'Learn how to create your first AI chatbot, train it on your website, and embed it in minutes with PageAI.',
};
...
const steps = [
  ...
  },
  {
    number: '04',
    title: 'Test Your Bot',
    description: 'Use the built-in chat interface to test your bot before embedding it on your site.',
    actions: [
      'Open your bot from the Bots dashboard',
      'Use the "Test Chat" panel to ask questions',
      'Check that answers are accurate and sourced from your content',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes — responses are streamed in real time using GPT-4.1. Most answers appear within 1–2 seconds.',
  },
  {
    q: 'How does the chatbot know what\'s on my website?',
    a: 'PageAI crawls your website, splits the text into chunks, and creates vector embeddings stored in our database. When a user asks a question, we find the most relevant chunks and pass them to GPT-4.1 along with the question — this is called RAG (Retrieval-Augmented Generation).',
  },
  {
  ...
  },
  {
    ...
    a: 'The widget inherits your brand colors and supports a custom avatar. Full white-label (remove PageAI branding) is available on Starter plan and above.',
  },
  {
    q: 'What data sources does PageAI support?',
    a: 'Website URLs, sitemap.xml files, and PDF/document uploads are available on all paid plans. Notion, Google Drive, and API connectors are available on Growth and above.',
  },
  {
    q: 'Is my data secure?',
            ...
            <div key={step.number} className="relative">
              ...
              <div className="flex gap-5">
                ...
                <div className="flex-1 pt-1 pb-2">
                  ...
                  <ol className="space-y-2 mb-4">
                    {step.actions.map((action, j) => (
                      <li key={j} className="flex items-start gap-3">
                        <span className="shrink-0 w-5 h-5 rounded-full bg-surface border border-edge flex items-center justify-center text-[11px] font-semibold text-fg-muted mt-0.5">
                          {j + 1}
                        </span>
                  ...
                  {step.code && (
                    <pre className="p-4 rounded-xl bg-surface border border-edge text-[13px] text-fg-secondary font-mono overflow-x-auto mb-4 whitespace-pre-wrap">
                      {step.code}
                    </pre>
                  )}
        ...
        <div className="max-w-[760px] mx-auto">
          <div className="p-8 md:p-12 rounded-2xl border border-primary/20 bg-primary/5 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/signup"
                className="px-6 py-3 rounded-xl bg-primary text-white font-semibold text-[15px] hover:bg-primary/90 transition-colors"
              >
                Start for free
              </Link>
              <Link
                href="/#pricing"
                className="px-6 py-3 rounded-xl border border-edge text-fg font-medium text-[15px] hover:bg-surface transition-colors"
              >
                View pricing
              </Link>
            </div>
