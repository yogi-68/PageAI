    ...
    <div className="space-y-6">
      ...
      {filtered.length === 0 ? (
        <div className="p-12 rounded-xl border border-edge bg-surface/40 text-center">
          ...
          <p className="text-[13px] text-fg-secondary mb-2 max-w-[380px] mx-auto">Your knowledge base is built from crawled website pages. Create a bot with a website source to get started.</p>
          <p className="text-[12px] text-fg-muted">Once crawled, your bots will use these pages to answer visitor questions accurately.</p>
        </div>
      ) : (
