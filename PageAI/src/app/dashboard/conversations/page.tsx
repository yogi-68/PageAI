  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[14px] text-fg-secondary mt-0.5">Read every chat your bots have had with visitors. Click any conversation to see the full transcript.</p>
      </div>
      ...
      {conversations.length === 0 ? (
        <div className="p-12 rounded-xl border border-edge bg-surface/40 text-center">
          ...
          <p className="text-[13px] text-fg-secondary mb-2 max-w-[380px] mx-auto">Conversations will appear here once visitors start chatting with your bots.</p>
          <p className="text-[12px] text-fg-muted">Tip: embed your bot on your website to start getting conversations.</p>
        </div>
      ) : (
